...
const styles = {
  ...
  footerContainer: {
    display: 'flex',
    flexDirection: 'column',  // Change to column by default for smaller screens
  ...
  logoContainer: {
    ...
    marginTop: '20px', // Add margin for separation in smaller screens
  },
  logo: {
...
const mediaQueries = {
  '@media (min-width: 768px)': {
    ...
    logoContainer: {
      justifyContent: 'flex-end', // Align logo to right for larger screens
